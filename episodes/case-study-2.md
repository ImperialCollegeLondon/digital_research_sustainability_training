...
- The energy used by cloud-storage provider to store Emma's backup data (**Scope 3**)
- Software licence for a proprietary analysis software (**Scope 3**)
...
Can you think of other options Emma might have?

:::::::::::::::::::::::: solution

Other options:

- replace the legacy Lab Desktop
...
- inneficient code generated by the an LLM
- old equipment
...
- data cleanup (e.g. delete data after 60 days if not accessed)
- reduce Lab Desktop idle time (e.g. configure the Desktop to sleep or hybernate
 after the script finishes)
- schedule scripts to run when the electricity grid is the cleanest
:::::::::::::::::::::::::::::::::
